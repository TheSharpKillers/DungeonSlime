...
namespace MonoGameLibrary.Graphics
{
    public class TextureAtlas
    {
        ...
        /// <param name="y">The top-left y-coordiante position of the region boundary relative to the top-left corner of the source texture boundary.</param>
        ...
        /// <summary>
        /// Gets the region from this texture atlas width the specified name.
        /// </summary>
        ...
        /// <summary>
        /// Removed the region from this texture atlas with the specified name.
        /// </summary>
        /// <param name="name">The name of the specified region to remove.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Ads the given animation to this texture atlas with the specified name.
        /// </summary>
        ...
        public static TextureAtlas FromFile(ContentManager content, string fileName)
        {
            ...
            using (Stream stream = TitleContainer.OpenStream(filePath))
            {
                using (XmlReader reader = XmlReader.Create(stream))
                {
                    ...
                    // The <Animations> element contains individual <Animation> elements,
                    // each one describing a different animation within the atlas.
                    //
                    // Example:
                    // <Animations>
