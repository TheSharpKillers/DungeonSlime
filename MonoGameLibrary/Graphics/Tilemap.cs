...
namespace MonoGameLibrary.Graphics
{
    public class Tilemap
    {
        ...
        /// <summary>
        /// Sets the tile at the given column in this tilemap to use the tile
        ...
        /// <summary>
        /// Create a new tilemap based on a tilemap xml configuration file.
        /// </summary>
        ...
        public static Tilemap FromFile(ContentManager content, string filename)
        {
            ...
            using (Stream stream = TitleContainer.OpenStream(filePath))
            {
                using (XmlReader reader = XmlReader.Create(stream))
                {
                    ...
                    //
                    // the contentPath value is the contentPath to set the texture to
                    ...
                    // Split the value of the tiles date into rows by splitting on the new line character.
