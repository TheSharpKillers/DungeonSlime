...
namespace MonoGameLibrary.Input
{
    ...
    {
        /// <summary>
        /// The state of the mouse input during the previus update cycle.
        /// </summary>
        ...
        /// <summary>
        /// Gets the differece in the mouse cursor position between the previous and current frame.
        /// </summary>
        public Point PositionDelta => CurrentState.Position - PreviousState.Position;

        /// <summary>
        /// Gets the differece in the mouse cursor x-position between the previous and current frame.
        /// </summary>
        public int XDelta => CurrentState.Position.X - PreviousState.Position.X;

        /// <summary>
        /// Gets the differece in the mouse cursor y-position between the previous and current frame.
        /// </summary>
