...
namespace MonoGameLibrary
{
    public readonly struct Circle : IEquatable<Circle>
    {
        ...
        /// <summary>
        /// Returns a value that indicates wheter the specified circle intersects with this circle.
        /// </summary>
        /// <param name="other">The other circle to check.</param>
        /// <returns>true of the other circle intersects with this circle; otherwise, false.</returns>
        ...
        /// <summary>
        /// Returns a value that indicates wheter this circle amd the specified object are equal.
        /// </summary>
        ...
        /// Returns a value that indicates wheter this circle amd the specified object are equal.
        /// </summary>
        /// <param name="other">The circle to comapre with this circle.</param>
        ...
        /// <summary>
        /// Returns a value that indicates if the circle on the left hand side of the equality operator is eqaul to the
        ...
        /// <summary>
        /// Returns a value that indicates if the circle on the left hand side of the equality operator is not eqaul to the
        /// circle on the right hand side of the equality operator.
        /// </summary>
        /// <param name="lhs">The circle on the left hand side of the equality operator.</param>
        /// <param name="rhs">The circle on the right hand side of the equality operator.</param>
