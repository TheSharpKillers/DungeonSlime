...
namespace DungeonSlime
{
    public class Game1 : Core
    {
        ...
        private void InitializeGum()
        {
            ...
            // the version of the default visuals to use. V3 is the latest version
            ...
            // The assets created for the UI where done so at 1/4th the size to keep the size of the 
