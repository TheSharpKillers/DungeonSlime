...
namespace DungeonSlime.Scenes
{
    public class GameScene : Scene
    {
        ...
        public override void Initialize()
        {
            ...
            // During the game scene, we wnat to disable exit on escape. Instead,
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            // Create a boudning circle for the bat.
            ...
            {
                // Choose a random row and column based in the total number of each.
        ...
        private void CheckKeyboardInput()
        {
            ...
            // If the W or the Up keys are down, move the slime up on the screen.
            if (keyboard.IsKeyDown(Keys.W) || keyboard.IsKeyDown(Keys.Up))
            {
                _slimePosition.Y -= speed;
            }

            // If the S or the Down keys are down, move the slime down on the screen.
            if (keyboard.IsKeyDown(Keys.S) || keyboard.IsKeyDown(Keys.Down))
            {
                _slimePosition.Y += speed;
            }

            // If the A or the Left keys are down, move the slime left on the screen.
            if (keyboard.IsKeyDown(Keys.A) || keyboard.IsKeyDown(Keys.Left))
            {
                _slimePosition.X -= speed;
            }

            // If the D or the Right keys are down, move the slime right on the screen.
            ...
            if (keyboard.WasKeyJustPressed(Keys.Add))
            {
            ...
            if (keyboard.WasKeyJustPressed(Keys.Subtract))
            {
                Core.Audio!.SongVolume -= 0.1f;
                Core.Audio.SoundEffectVolume -= 0.1f;
            }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            // Begin the sprice batch to prepare for rendering.
