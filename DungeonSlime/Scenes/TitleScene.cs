...
namespace DungeonSlime.Scenes
{
    public class TitleScene : Scene
    {
        ...
        // The font to use render normal text.
        ...
        private AnimatedButton _optionsButton = null!;
        private AnimatedButton _optionsBackButton = null!;
        ...
        public override void Initialize()
        {
            ...
            // Initialize the offset of the background pattern to zero.
        ...
        public override void LoadContent()
        {
            ...
            // Load the sound effect to play when the ui action occur.
            _uiSoundEffect = Core.Content.Load<SoundEffect>("Audio/ui");

            // Load the texture atlas from the xml configuartion file
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (_titleScreenButtonsPanel.IsVisible)
            {
                ...
                // with a transparant color to give it a drop shadow.
        ...
        {
            // Itentionally not playing the UI sound effect here so that it is not
        ...
        {
            // Clear out any prevoius UI in case we came here from a different screen:
