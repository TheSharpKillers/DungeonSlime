...
namespace DungeonSlime.GameObjects
{
    public class Slime
    {
        ...
        private Queue<Vector2> _inputBuffer = null!;
        ...
        private void Move()
        {
            ...
            // Update the direction the head is supposed to move in to the next direction cached
            head.Direction = _nextDirection;

            // Update the head's "at" position to be where it was moving "to"
            head.At = head.To;

            // Update the head's "to" position to the next tile in the direction it is moving
            ...
            // segment and update its "at" and "to" position
        ...
        public void Draw()
        {
            ...
            {
                // Calculate the visual position of the segment at he moment by
                // lerping between its "at" and "to" position by the movement
                // offset lerp amount
                Vector2 pos = Vector2.Lerp(segment.At, segment.To, _movementProgress);

                // Draw the slime sprite at the calculated visual position of this segment
                _sprite.Draw(Core.SpriteBatch!, pos);
            }
        }

        /// <summary>
        /// Returns a Circle value that represents collision of the slime.
        /// </summary>
