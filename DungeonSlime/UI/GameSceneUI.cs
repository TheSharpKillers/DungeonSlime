...
namespace DungeonSlime.UI
{
    public class GameSceneUI : ContainerRuntime
    {
        ...
        private AnimatedButton _retryButton = null!;
        ...
        public GameSceneUI()
        {
            ...
            // Get a reference to the content manager that was registred with the
            ...
            // Create the text that will display the players score and add ot as
